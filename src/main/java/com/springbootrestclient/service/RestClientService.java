package com.springbootrestclient.service;
...
import com.springbootrestclient.dto.User;
...
public class RestClientService {
	...
	public ResponseEntity<User[]> getAll() {
		ResponseEntity<User[]> response = restTemplate.getForEntity("https://jsonplaceholder.typicode.com/users/",
				User[].class);
		return response;
	}
